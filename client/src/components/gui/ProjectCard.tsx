      ...
      <div className="flex items-start justify-between mb-1">
        {liveHref ? (
          <a
            ...
            className="text-white font-bold text-lg hover:text-gui-accent transition-colors"
        ...
        <div className="flex items-center gap-3 ml-auto">
          {liveHref && (
            <a
              ...
              target={liveIsInternal ? undefined : '_blank'}
              rel={liveIsInternal ? undefined : 'noopener noreferrer'}
              className="text-gui-accent text-xs font-mono hover:text-gui-accent-hover transition-colors"
              title="View live"
            >
              live →
            </a>
